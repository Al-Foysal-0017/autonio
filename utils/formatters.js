 ...
 *
 * @param num
 * @param type 0: niox format, 1: usd format
 * @returns
 */
export const getFormattedNumber = (num, type = null) => {
  const formatter = new Intl.NumberFormat("en-US");

  return (
    (1 === type ? "$" : "") + formatter.format(num) + (0 == type ? " NIOX" : "")
  );
};
...
export const getFormattedMonthAndDate = (timestamp) => {
